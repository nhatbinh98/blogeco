...
<header>
        <div class="info_top">
            <div class="bg_in">
                <p class="p_infor">
                    <span><i class="fa fa-envelope-o" aria-hidden="true"></i>Email: @gmail.com</span>
                    <span><i class="fa fa-phone" aria-hidden="true"></i> Hotline: 09xx-xxx-xxx</span>
                </p>
            </div>
        </div>
                        ...
                        <div class="search_top">
                            <div id='cssmenu'>
                                <ul>
                                    ...
                                    <li class=''><a href='<?php echo BASE_URL ?>imdex/lienhe'>Giới thiệu</a></li>
                                    ...
                                    <li class=''><a href='<?php echo BASE_URL ?>imdex/lienhe'>Liên hệ</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="clear"></div>
