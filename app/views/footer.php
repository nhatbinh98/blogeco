  <footer>
            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a target="_blank"  href="#" class="fb"><img src="<?php echo BASE_URL ?>public/images/Fb.png">Facebook</a></li>
                           <li><a target="_blank" href="#" class="fb"><img height="32" width="32" src="<?php echo BASE_URL ?>public/images/youtube.png">Youtube</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline: 09xx-xxx-xxx </span>
                                    <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i> aaa </a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>aaa  </a></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <div class="bg_in">
               <div class="footer">
                  <div class="infor_company">
                     ...
                     <p class="note_mst">GPĐKKD số: . Cấp lần 1: . Thay đổi: . Nơi cấp: Phòng đăng ký kinh doanh Sở kế hoạch đầu tư TP Hồ Chí Minh</p>
                  </div>
                  <div class="footer-col">
                     <h4>TRỤ SỞ CHÍNH</h4>
      ...
      <div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon" >
         <a href="tel:093" title="Gọi ngay cho chúng tôi">
